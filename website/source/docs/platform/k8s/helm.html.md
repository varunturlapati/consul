...
configuration into the `consul-system` namespace, run:

```sh
$ helm install --namespace consul-system --name consul ./consul-helm
NAME:   consul
...
...
```bash
$ helm install --namespace consul-system --name consul -f ./values.yaml ./consul-helm
```
...
```bash
$ helm install --wait --namespace consul-system --name consul -f ./values.yaml ./consul-helm
```
